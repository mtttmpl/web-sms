<div class="col-sm-3 col-md-2 sidebar">
    <ul class="nav nav-sidebar">
        <li <?php if($selected == 'inbox') { echo ' class="active"'; } ?>><a href="<?php echo base_url(); ?>folders/inbox">Inbox <?php if(isset($counts['inbox']) && $counts['inbox'] > 0) { echo '<span class="badge pull-right">'.$counts['inbox'].'</span>'; } ?></a></li>
