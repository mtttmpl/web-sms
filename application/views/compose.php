<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    ?>
        <div class="form-group">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="inputEmail3" placeholder="Number" name="to" value="<?php set_value('to'); ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="inputMessage" class="col-sm-2 control-label">Message</label>
            <div class="col-sm-10">
            <textarea class="form-control" id="inputMessage" placeholder="Message" name="message"><?php set_value('message'); ?</textarea>
            </div>
        </div>
        <div class="form-group">
